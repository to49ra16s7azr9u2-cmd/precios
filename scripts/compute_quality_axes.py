...
USOS = {
    ...
    ("Autos y motos/Bocinas para auto", "power_w"): (("Suave", "Media", "Fuerte"),
        ("Para oír música con claridad", "Más presencia y bajos", "Para que se oiga desde afuera")),
    ("Autos y motos/Bocinas para auto", "size_in"): (("Chica", "Mediana", "Grande"),
...
INTROS = {
    ...
    "Autos y motos/Cascos para moto": "Empieza por el tipo y tu talla: un casco flojo no protege.",
