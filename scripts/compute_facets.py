...
NOMBRE_GENERALES = {
    ...
    ("Deportes y fitness", "Sets de pesas"): [("weight_kg", lambda t: se.kg_of(t, 0.5, 300))],
    ("Deportes y fitness", "Balones de fútbol"): [("ball_no", se.ball_number_of)],
    ("Deportes y fitness", "Balones de básquetbol"): [("ball_no", se.ball_number_of)],
    ("Deportes y fitness", "Balones de voleibol"): [("ball_no", se.ball_number_of)],
