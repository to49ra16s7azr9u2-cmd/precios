(() => {
  ...
  const SPEC_FACETS = [
    ...
    { key: "rimSize", facetField: "rim_size", categories: ["Autos, bicicletas y motos", "Autos y motos"], label: "Medida de rin", groupEl: "filterRimSizeGroup", listEl: "filterRimSize", format: (v) => v },
    { key: "wheelSize", facetField: "wheel_size", categories: ["Autos, bicicletas y motos", "Bicicletas y movilidad"], label: "Rodada", groupEl: "filterWheelSizeGroup", listEl: "filterWheelSize", format: (v) => v },
  ...
  const el = {
    ...
    filterModelGroup: document.getElementById("filterModelGroup"),
    ...
    filterRimSize: document.getElementById("filterRimSize"),
    filterWheelSizeGroup: document.getElementById("filterWheelSizeGroup"),
    filterWheelSize: document.getElementById("filterWheelSize"),
    filterFuelGroup: document.getElementById("filterFuelGroup"),
    filterFuel: document.getElementById("filterFuel"),
    filterBurnersGroup: document.getElementById("filterBurnersGroup"),
    filterBurners: document.getElementById("filterBurners"),
    filterGenderGroup: document.getElementById("filterGenderGroup"),
  ...
  const QUALITY_AXES = {
    ...
    Videojuegos: [
      ...
      {
        // Para quién es. Las siete clasificaciones que publica la tienda se
        // agrupan en tres tramos: en tarjetas, siete no se leen, y quien
        // compra un regalo decide entre "para un niño", "para un
        // adolescente" y "para un adulto".
        key: "size", label: "Edad", field: "age_rating", criterion: "recomendada",
        tiers: [
          { id: "todos", name: "Todo público", use: "Para jugar en familia", spec: "Todo público y 10+", match: (v) => ["Todo público", "10 años o más"].includes(v) },
          { id: "ado", name: "Adolescentes", use: "De 12 a 15 años", spec: "12, 13 y 15 años o más", match: (v) => ["12 años o más", "13 años o más", "15 años o más"].includes(v) },
          { id: "adultos", name: "Adultos", use: "Contenido para mayores", spec: "17 y 18 años o más", match: (v) => ["17 años o más", "18 años o más"].includes(v) },
        ],
      },
    ],
  ...
  const CATEGORY_SHIPPING_DEFAULTS = {
    ...
    "Autos y motos": { weightKg: 12, lengthCm: 70, widthCm: 70, heightCm: 30 },
    "Bicicletas y movilidad": { weightKg: 15, lengthCm: 140, widthCm: 25, heightCm: 75 },
